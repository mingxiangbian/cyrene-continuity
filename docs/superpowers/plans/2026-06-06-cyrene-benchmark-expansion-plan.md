...
- Create/Modify: `docs/superpowers/benchmark-artifacts/2026-06-06/...`
- Modify: `docs/superpowers/benchmark-results/2026-06-06-cyrene-benchmark-results.md`
...
```text
docs/superpowers/benchmark-artifacts/2026-06-06/<profile>/benchmark_report.json
docs/superpowers/benchmark-artifacts/2026-06-06/<profile>/benchmark_report.md
```
...
- [ ] Archive key report artifacts under `docs/superpowers/benchmark-artifacts/2026-06-06/`
- [ ] Run full `npm test`

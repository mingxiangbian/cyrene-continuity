...
describe('Codex UI source assets', () => {
  ...
  it('contains the Warm Cream Coral console shell and write-confirm review labels', async () => {
    ...
    expect(js).toContain('Next run')
    expect(js).toContain('Storage / Origin')
    expect(js).toContain('Source boundary')
    expect(js).toContain('memoryOriginLabel')
    expect(js).toContain('sourceBoundaryLabel')
    expect(js).not.toContain('Dream status')
    expect(js).not.toContain('dreamDue')
    expect(js).not.toContain('lastDreamAt')
    expect(js).not.toContain('lastDreamStatus')
